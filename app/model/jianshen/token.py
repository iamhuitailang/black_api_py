...
class JianshenTokenModel:
    TABLE_NAME = 'tb_jianshen_token'
    ...
    def create_token(self, user_id: int, hours: int = 24 * 30) -> str:
    ...
    def get_user_by_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        if not token_record:
            return None
        from app.model.jianshen.user import JianshenUserModel
        user_model = JianshenUserModel()
    ...
    def delete_by_user_id(self, user_id: int) -> int:
        return self.exec.execute_raw(f"DELETE FROM {self.TABLE_NAME} WHERE user_id = ?", (user_id,))
