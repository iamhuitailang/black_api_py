...
class HepingAdminTokenModel:
    TABLE_NAME = 'tb_heping_model_admin_tokens'
    ...
    def get_admin_by_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        from app.model.heping_model.admin import HepingAdminModel
        admin_model = HepingAdminModel()
