...
class UserModel:
    ...
    def create(self, username: str, password: str, nickname: str = '',
               email: str = '', phone: str = '', role: str = 'user', avatar: str = '') -> int:
    ...
    def init_default_admin(cls):
        model = cls()
        existing = model.query.find_one({'username': 'admin'})
        if existing:
            return
        model.create(
            username='admin',
    ...
    def search(self, keyword: str, page: int = 1, page_size: int = 10,
        ...
        where_clauses.append("(username LIKE ? OR nickname LIKE ? OR email LIKE ? OR phone LIKE ?)")
