...
class XiangqiAdminTokenModel:
    TABLE_NAME = 'tb_xiangqi077_model_admin_token'
    ...
    def get_admin_by_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        from app.model.xiangqi077_model.admin import XiangqiAdminModel
        admin_model = XiangqiAdminModel()
