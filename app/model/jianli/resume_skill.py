...
class ResumeSkillModel:
    TABLE_NAME = 'tb_jianli_resume_skills'
    ...
    def create(self, resume_id: int, user_id: int, skill_name: str,
               skill_level: int = 0, description: str = '', sort_order: int = 0) -> int:
    ...
    def update(self, record_id: int, data: Dict[str, Any]) -> int:
        ...
        update_data = {k: v for k, v in data.items() if k in [
            'skill_name', 'skill_level', 'description', 'sort_order'
        ]}
    ...
    def to_public_dict(self, skill: Dict[str, Any]) -> Dict[str, Any]:
        return {
            ...
            'skill_level_text': self.get_level_text(skill.get('skill_level', 0)),
            'description': skill.get('description'),
            'sort_order': skill.get('sort_order'),
