...
class UserModel:
    ...
    def create(self, username: str, password: str, phone: str = '', email: str = '', nickname: str = '') -> int:
        ...
        data = {
            ...
            'salt': salt,
            'nickname': nickname or f'用户{username}',
            'avatar': '',
    ...
    def search(self, keyword: str, page: int = 1, page_size: int = 10, status: int = None) -> Dict[str, Any]:
        ...
        where_clauses.append("(username LIKE ? OR nickname LIKE ? OR phone LIKE ? OR email LIKE ?)")
