...
class UserModel:
    TABLE_NAME = 'tb_biaoqing_model_users'
    ...
    def create(self, username: str, email: str, password: str, nickname: str = '', phone: str = '') -> int:
    ...
    def update_profile(self, user_id: int, data: Dict[str, Any]) -> int:
        ...
        update_data = {k: v for k, v in data.items() if k in [
            'nickname', 'avatar', 'signature', 'phone'
        ]}
    ...
    def search(self, keyword: str, page: int = 1, page_size: int = 10,
        ...
        where_clauses.append("(username LIKE ? OR email LIKE ? OR nickname LIKE ? OR phone LIKE ?)")
