...
class LlkUserModel:
    TABLE_NAME = 'tb_lianliankan077_model_user'
    ...
    def update_score(self, user_id: int, score: int) -> int:
        ...
        new_highest = max(user.get('highest_score', 0), score)
    ...
    def get_leaderboard(self, page: int = 1, page_size: int = 20) -> Dict[str, Any]:
        return self.query.paginate(
            ...
            fields=['id', 'username', 'nickname', 'avatar', 'total_score', 'games_played', 'highest_score'],
