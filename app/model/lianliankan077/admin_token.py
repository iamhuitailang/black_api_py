...
class LlkAdminTokenModel:
    TABLE_NAME = 'tb_lianliankan077_model_admin_token'
    ...
    def get_admin_by_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        from app.model.lianliankan077.admin import LlkAdminModel
        admin_model = LlkAdminModel()
