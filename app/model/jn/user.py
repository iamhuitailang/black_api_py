...
class UserModel:
    ...
    def create_table(cls):
        ...
        index_sql3 = f"CREATE INDEX IF NOT EXISTS idx_{cls.TABLE_NAME}_credit ON {cls.TABLE_NAME}(credit)"
    ...
    def reset_credit(self, user_id: int) -> int:
        now = datetime.now().isoformat()
        data = {
            'credit': 100,
            'updated_at': now
    ...
    def search(self, keyword: str, page: int = 1, page_size: int = 10,
        ...
        where_clauses.append("(phone LIKE ? OR nickname LIKE ? OR location LIKE ?)")
