...
class ErshoushuNotificationModel:
    TABLE_NAME = 'tb_ershoushu_077_model_notification'
    ...
    def create(self, user_id: int, title: str, content: str, ntype: str = 'system',
               related_id: int = 0) -> int:
    ...
    def delete(self, notification_id: int) -> int:
        return self.exec.delete_by_id(notification_id)
