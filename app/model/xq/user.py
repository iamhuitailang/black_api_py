...
class UserModel:
    ...
    def create_table(cls):
        ...
        db.execute(index_sql)
        index_sql = f"CREATE INDEX IF NOT EXISTS idx_{cls.TABLE_NAME}_community ON {cls.TABLE_NAME}(community)"
        db.execute(index_sql)
    ...
    def create(self, phone: str, password: str, nickname: str = '', community: str = '') -> int:
    ...
    def get_all(self, page: int = 1, page_size: int = 10, status: int = None,
                community: str = None, keyword: str = None) -> Dict[str, Any]:
        conditions = {}
        ...
        if keyword:
            return self.search(keyword, page, page_size, status, community)

        return self.query.paginate(page, page_size, conditions, order_by='id DESC')

    def search(self, keyword: str, page: int = 1, page_size: int = 10,
               status: int = None, community: str = None) -> Dict[str, Any]:
        ...
        where_clauses.append("(phone LIKE ? OR nickname LIKE ? OR community LIKE ?)")
