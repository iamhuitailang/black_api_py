...
from app.model.jiudian_077_model import UserModel, TokenModel
import re


class JiudianUserBusiness:
    def __init__(self):
    ...
    def register(self, username: str, phone: str, password: str, nickname: str = '') -> Dict[str, Any]:
        ...
        user_id = self.user_model.create(username, phone, password, nickname)
        if user_id > 0:
