...
from app.model.heping_model import HepingUserModel, HepingTokenModel
import re


class HepingUserBusiness:
    def __init__(self):
        self.user_model = HepingUserModel()
        self.token_model = HepingTokenModel()
        ...
        if user:
            ...
            if user_full:
                return {
                    'code': 0,
                    'msg': 'success',
                    'data': self.user_model.to_public_dict(user_full)
                }
