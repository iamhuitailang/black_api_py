...
from app.model.huodong import HuodongUserModel, HuodongTokenModel
import re


class HuodongUserBusiness:
    def __init__(self):
        self.user_model = HuodongUserModel()
        self.token_model = HuodongTokenModel()
    ...
    def register(self, phone: str, password: str, nickname: str = '', city: str = '') -> Dict[str, Any]:
        ...
        user_id = self.user_model.create(phone, password, nickname, city)
        if user_id > 0:
    ...
    def login(self, phone: str, password: str) -> Dict[str, Any]:
        ...
        if user is None:
            return {'code': 1, 'msg': '手机号或密码错误', 'data': None}
    ...
    def update_profile(self, user_id: int, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if affected >= 0:
            ...
            return {'code': 0, 'msg': '更新成功', 'data': self.user_model.to_public_dict(updated)}
    ...
    def change_password(self, user_id: int, old_password: str, new_password: str) -> Dict[str, Any]:
        ...
        verify = self.user_model.verify_password(phone, old_password)
        if verify is None:
    ...
    def get_user_list(self, page: int = 1, page_size: int = 10,
                      status: int = None, city: str = None, keyword: str = None) -> Dict[str, Any]:
        result = self.user_model.get_all(page, page_size, status, city, keyword)
