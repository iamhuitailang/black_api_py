...
from app.model.kuaidi_077_model import KuaidiUserModel, KuaidiTokenModel, KuaidiPackageModel
import re


class KuaidiUserBusiness:
    def __init__(self):
        self.user_model = KuaidiUserModel()
        self.token_model = KuaidiTokenModel()
    ...
    def register(self, phone: str, password: str, nickname: str = '') -> Dict[str, Any]:
        ...
        if user_id > 0:
            self.package_model.bind_user_id(phone, user_id)
