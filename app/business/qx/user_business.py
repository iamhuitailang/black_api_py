...
from app.model.qx import UserModel, QxTokenModel
import re


class QxUserBusiness:
    def __init__(self):
        self.user_model = UserModel()
        self.token_model = QxTokenModel()
    ...
    def register(self, phone: str, password: str, nickname: str = '',
                 avatar: str = '', bike_type: str = '', bio: str = '') -> Dict[str, Any]:
        ...
        if bike_type and bike_type not in UserModel.BIKE_TYPES:
            bike_type = UserModel.BIKE_TYPE_ROAD
        ...
        user_id = self.user_model.create(
            ...
            nickname=nickname,
            avatar=avatar,
            bike_type=bike_type or UserModel.BIKE_TYPE_ROAD,
            bio=bio
        )
    ...
    def get_user_list(self, page: int = 1, page_size: int = 10,
                      status: int = None, level: str = None, keyword: str = None) -> Dict[str, Any]:
        result = self.user_model.get_all(page, page_size, status, level, keyword)
    ...
    def get_ranking(self, sort_by: str = 'distance', page: int = 1, page_size: int = 10) -> Dict[str, Any]:
        result = self.user_model.get_ranking(sort_by, page, page_size)
        return {
            'code': 0,
            'msg': 'success',
            'data': result
