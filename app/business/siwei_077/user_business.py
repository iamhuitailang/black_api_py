...
from app.model.siwei_077_model import SiweiUserModel, SiweiTokenModel
import re


class SiweiUserBusiness:
    def __init__(self):
        self.user_model = SiweiUserModel()
        self.token_model = SiweiTokenModel()
    ...
    def register(self, username: str, password: str, nickname: str = '') -> Dict[str, Any]:
        if not self._validate_username(username):
            return {'code': 1, 'msg': '用户名至少3个字符，只支持字母数字下划线和中文', 'data': None}
