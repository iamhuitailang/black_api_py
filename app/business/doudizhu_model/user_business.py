...
from app.model.doudizhu_model import UserModel, DoudizhuTokenModel
import re


class DoudizhuUserBusiness:
    def __init__(self):
        self.user_model = UserModel()
        self.token_model = DoudizhuTokenModel()
    ...
    def get_ranking_list(self, page: int = 1, page_size: int = 100, sort_by: str = 'coins') -> Dict[str, Any]:
        result = self.user_model.get_ranking_list(page, page_size, sort_by)
        items = [self.user_model.to_public_dict(item) for item in result.get('items', [])]
