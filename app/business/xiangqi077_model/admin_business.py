...
from app.model.xiangqi077_model import XiangqiAdminModel, XiangqiAdminTokenModel


class XiangqiAdminBusiness:
    def __init__(self):
        self.admin_model = XiangqiAdminModel()
        self.token_model = XiangqiAdminTokenModel()
    ...
    def login(self, username: str, password: str) -> Dict[str, Any]:
        ...
        return {
            'code': 0,
            'msg': '登录成功',
            'data': {'admin': self.admin_model.to_dict(admin_full), 'token': token}
        }
    ...
    def change_password(self, admin_id: int, old_password: str, new_password: str) -> Dict[str, Any]:
        ...
        verify_result = self.admin_model.verify_password(admin.get('username', ''), old_password)
    ...
    def delete_admin(self, admin_id: int) -> Dict[str, Any]:
        ...
        self.token_model.delete_by_admin_id(admin_id)
        self.admin_model.delete(admin_id)
    ...
    def disable_admin(self, admin_id: int) -> Dict[str, Any]:
        ...
        self.admin_model.update_status(admin_id, XiangqiAdminModel.STATUS_DISABLED)
        self.token_model.delete_by_admin_id(admin_id)
    ...
    def enable_admin(self, admin_id: int) -> Dict[str, Any]:
        ...
        if not admin:
            return {'code': 1, 'msg': '管理员不存在', 'data': None}
        self.admin_model.update_status(admin_id, XiangqiAdminModel.STATUS_ACTIVE)
