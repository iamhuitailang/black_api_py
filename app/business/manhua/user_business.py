...
from app.model.manhua import UserModel, TokenModel, ReadingSettingsModel
import re


class ManhuaUserBusiness:
    def __init__(self):
    ...
    def register(self, username: str, password: str, nickname: str = '', email: str = '') -> Dict[str, Any]:
        ...
        if user_id > 0:
            self.settings_model.create_default(user_id)
