...
from app.model.tanke import TankeUserModel, TankeTokenModel, TankeTankModel
import re


class TankeUserBusiness:
    def __init__(self):
        self.user_model = TankeUserModel()
        self.token_model = TankeTokenModel()
    ...
    def register(self, username: str, password: str, nickname: str = '') -> Dict[str, Any]:
        ...
        if user_id > 0:
            self.tank_model.create_default_for_user(user_id)
            ...
            return {
                ...
                'data': {
                    ...
                    'tank': self.tank_model.to_public_dict(tank),
                    'token': token
                }
            }
    ...
    def login(self, username: str, password: str) -> Dict[str, Any]:
        ...
        tank = self.tank_model.get_or_create_for_user(user.get('id'))
