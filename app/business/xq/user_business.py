...
from app.model.xq import UserModel, XqTokenModel
import re


class XqUserBusiness:
    def __init__(self):
        self.user_model = UserModel()
        self.token_model = XqTokenModel()
    ...
    def register(self, phone: str, password: str, nickname: str = '', community: str = '') -> Dict[str, Any]:
        ...
        user_id = self.user_model.create(phone, password, nickname, community)
        if user_id > 0:
    ...
    def get_user_list(self, page: int = 1, page_size: int = 10,
                      status: int = None, community: str = None, keyword: str = None) -> Dict[str, Any]:
        result = self.user_model.get_all(page, page_size, status, community, keyword)
