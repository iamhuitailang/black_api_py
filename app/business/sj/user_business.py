...
from app.model.sj_model import SjUserModel, SjTokenModel


class SjUserBusiness:
    def __init__(self):
        self.user_model = SjUserModel()
        self.token_model = SjTokenModel()
    ...
    def register(self, username: str, password: str, nickname: str = '') -> Dict[str, Any]:
        if not self._validate_username(username):
            return {'code': 1, 'msg': '用户名长度需3-20位', 'data': None}
