...
def init_database():
    ...
    AlchemyRecipeModel.create_table()
    AlchemyGameModel.create_table()
    AlchemyRecipeModel.seed_data()
...
@app.get("/alchemy")
async def alchemy_game():
    html_path = os.path.join(os.path.dirname(__file__), "static", "alchemy", "index.html")
