...
from app.model.vault import VaultSaveModel, VaultResidentModel, VaultFacilityModel, VaultResourceModel, VaultLogModel
...
def init_database():
    ...
    VaultSaveModel.create_table()
    VaultResidentModel.create_table()
    VaultFacilityModel.create_table()
    VaultResourceModel.create_table()
    VaultLogModel.create_table()
