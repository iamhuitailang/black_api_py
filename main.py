...
from app.model.parking import ParkingSpotModel, ParkingApplicationModel, ParkingPaymentModel
...
def init_database():
    ...
    ParkingSpotModel.create_table()
    ParkingApplicationModel.create_table()
    ParkingPaymentModel.create_table()
    
    ParkingSpotModel.seed_initial_data()
