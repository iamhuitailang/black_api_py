...
from app.model.prismgame import LevelModel, PrismModel, SolutionModel, ScoreboardModel
...
def init_database():
    ...
    PrismModel.create_table()
    SolutionModel.create_table()
    ScoreboardModel.create_table()
