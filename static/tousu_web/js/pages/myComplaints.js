const MyComplaintsPage = {
    ...
    async render() {
        ...
        app.innerHTML = `
            <div class="page has-header">
                ${Layout.renderHeader('我的提交', true)}

                <div class="filter-tabs">
                    <div class="filter-tab ${this.currentFilter === 'all' ? 'active' : ''}" data-filter="all">全部</div>
                    <div class="filter-tab ${this.currentFilter === 'pending' ? 'active' : ''}" data-filter="pending">待处理</div>
                ...
                ${Layout.renderTabbar('myComplaints')}
            </div>
        `;
    ...
    async loadComplaints() {
        ...
        try {
            ...
            const result = await ApiService.get('/tousu/complaint/my/list/get', params);
...
window.MyComplaintsPage = MyComplaintsPage;