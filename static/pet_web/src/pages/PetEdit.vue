<template>
  <Layout>
    <div class="pet-edit-page page-container" v-loading="loading">
      <div class="card">
        <h2>编辑宠物信息</h2>
        <p class="subtitle">修改宠物信息，帮助它们找到温暖的家</p>
        <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" class="publish-form" v-if="petData">
          ...
          <el-form-item label="宠物图片">
            ...
            <el-input v-model="form.images" placeholder="多个图片URL用逗号分隔" />
          </el-form-item>
          <el-form-item>
...
function updateHealthStatus() {
  healthStatus.value = []
  if (form.vaccinated) healthStatus.value.push('vaccinated')
  if (form.sterilized) healthStatus.value.push('sterilized')
  if (form.dewormed) healthStatus.value.push('dewormed')
}
